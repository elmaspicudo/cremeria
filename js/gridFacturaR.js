...
Ext.extend(listaCotb.datos,Ext.data.Store,{load_listaCotb:function(tipo,valor,padre){this.load({params:{listado:18,cvepadre:padre,consulta:tipo,where:valor}});}});
...
var gridCotb=new Ext.grid.GridPanel
 ...
 cargaCotb.load_listaCotb(2,0,0);
