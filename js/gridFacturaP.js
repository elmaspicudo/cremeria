...
Ext.extend(listaCotb.datos,Ext.data.Store,{load_listaCotb:function(tipo,valor,padre){this.load({params:{listado:19,cvepadre:padre,consulta:tipo,where:valor}});}});
...
var gridCotb=new Ext.grid.GridPanel
 ...
 cargaCotb.load_listaCotb(3,0,0);
